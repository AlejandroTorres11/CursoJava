...
public class CuentaBancaria {
    ...
    public CuentaBancaria(String numCuenta, String dni, String titular, double saldo, Date fechaAlta, boolean bloqueada) {
        try {
    ...
    public int generarAleatorio(int cantidad){
        ...
        for (int i = 0; i < cantidad; i++) {
            int numeroAleatorio = random.nextInt(9) + 1; // Genera un número aleatorio entre 1 y 9
